  ...
  const meaning = meanings.map((m, i) => (
    <section key={m.partOfSpeech + i}>
      <div className="flex justify-between items-center gap-4 mb-7">
        ...
        <div className="h-[1px] w-max border flex-grow border-CustomGray-light-400"></div>
      </div>
    ...
    <main>
      <div className="flex justify-between items-center mb-7">
        ...
        <button
          ...
          active:scale-95 hover:scale-110 transition-transform"
        >
          <img src={PLAY_ICON} />
        </button>
      </div>
      {meaning}
      <section className="text-CustomGray-light-400 border-t-2 border-CustomGray-light-400">
